...
import framework.reports.Reports;
...
public class WebActions6 {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//Start the reporting for a test case
		Reports.startReporting("Test 1: Automation Practice Form Submission");
		
		//1. Launch browser window(Chrome)   
		driver = new ChromeDriver();
		Reports.logger.info("Chrome browser is launched successfully.");
		
		//2. Maximize the browser window
		driver.manage().window().maximize();
		Reports.logger.info("Browser window is maximized successfully.");
		
		//3. Delete all the cookies 
		driver.manage().deleteAllCookies();
		Reports.logger.info("All the cookies are deleted successfully.");
		
		//4. Enter URL and Launch the application (https://demoqa.com/automation-practice-form)   
		driver.get("https://demoqa.com/automation-practice-form");
		Reports.logger.pass("Application URL is launched successfully.");
		
		//5. Wait for Page-load
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		wait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.xpath("//h1[text()='Practice Form']"), 0));
		Reports.logger.info("Application page is loaded successfully.");
		...
		Reports.logger.info("First name and Last name are entered successfully.");
		
		//7. Enter Email     
		WebElement email = driver.findElement(By.xpath("//input[@id='userEmail']"));
		email.sendKeys("johndoe@gmail.com");
		Reports.logger.info("Email is entered successfully.");
		
		//8. Select Gender (Male)    
		selectGender("Male");
		Reports.logger.warning("selected Gender successfully.");
		...
		Reports.logger.info("Photo is uploaded successfully.");
		...
		Reports.logger.pass("Form is submitted successfully.");
		
		//Take the screenshot.
		takeScreenshot(driver, "FileSubmission");
		Reports.logger.info("Screenshot is taken successfully.");
		Reports.attachScreenshot(takeScreenshot(driver, "FileSubmission"));
		
		//16. Close browser window
		driver.quit();
		Reports.logger.info("Browser is closed successfully.");
